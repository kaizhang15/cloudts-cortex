module github.com/kaizhang15/cloudts-cortex
...
require (
	...
	github.com/cortexproject/cortex v1.16.0
...
replace github.com/cortexproject/cortex => github.com/cortexproject/cortex v1.16.0
