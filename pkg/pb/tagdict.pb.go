...
type TagDictSnapshot_TrieNode struct {
	...
	Type          NodeType               `protobuf:"varint,4,opt,name=type,proto3,enum=pb.NodeType" json:"type,omitempty"`       // 节点类型枚举
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_tagdict_proto_rawDesc = "" +
	"\n" +
	"\rtagdict.proto\x12\x02pb\"\x86\x04\n" +
	"\x0fTagDictSnapshot\x122\n" +
	"\x05nodes\x18\x01 \x03(\v2\x1c.pb.TagDictSnapshot.TrieNodeR\x05nodes\x12=\n" +
	"\n" +
	"partitions\x18\x02 \x03(\v2\x1d.pb.TagDictSnapshot.PartitionR\n" +
	"partitions\x12#\n" +
	"\rnext_encoding\x18\x03 \x01(\rR\fnextEncoding\x1a\x8a\x01\n" +
	"\bTrieNode\x12#\n" +
	...
	"\x04type\x18\x04 \x01(\x0e2\f.pb.NodeTypeR\x04type\x1a\xcd\x01\n" +
	"\tPartition\x12!\n" +
	"\fpartition_id\x18\x01 \x01(\x04R\vpartitionId\x12Z\n" +
	"\x0ftag_frequencies\x18\x02 \x03(\v21.pb.TagDictSnapshot.Partition.TagFrequenciesEntryR\x0etagFrequencies\x1aA\n" +
	...
	"\tTAG_VALUE\x10\x03B-Z+github.com/kaizhang15/cortex-cloudts/pkg/pbb\x06proto3"
...
var file_tagdict_proto_goTypes = []any{
	(NodeType)(0),                     // 0: pb.NodeType
	(*TagDictSnapshot)(nil),           // 1: pb.TagDictSnapshot
	(*TagDictSnapshot_TrieNode)(nil),  // 2: pb.TagDictSnapshot.TrieNode
	(*TagDictSnapshot_Partition)(nil), // 3: pb.TagDictSnapshot.Partition
	nil,                               // 4: pb.TagDictSnapshot.Partition.TagFrequenciesEntry
}
var file_tagdict_proto_depIdxs = []int32{
	2, // 0: pb.TagDictSnapshot.nodes:type_name -> pb.TagDictSnapshot.TrieNode
	3, // 1: pb.TagDictSnapshot.partitions:type_name -> pb.TagDictSnapshot.Partition
	0, // 2: pb.TagDictSnapshot.TrieNode.type:type_name -> pb.NodeType
	4, // 3: pb.TagDictSnapshot.Partition.tag_frequencies:type_name -> pb.TagDictSnapshot.Partition.TagFrequenciesEntry
